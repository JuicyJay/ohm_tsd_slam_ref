...
\hline
\end{DoxyParams}
todo nullptr? bzw wofür hab ich das hier eig. variable wird nicht benutzt?

Random\-Matcher options

todo W\-A\-R\-U\-M H\-I\-E\-R name\-Space und nicht \-\_\-name\-Space wie unten

todo nullptr? unten auch?

todo wofür wird der genullt? wird gleich hier unten initialisiert \hypertarget{classohm__tsd__slam__ref_1_1ThreadLocalize_ad6d771a1b24111bff419ecfed45ee470}{\index{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize@{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize}!$\sim$\-Thread\-Localize@{$\sim$\-Thread\-Localize}}
\index{$\sim$\-Thread\-Localize@{$\sim$\-Thread\-Localize}!ohm_tsd_slam_ref::ThreadLocalize@{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize}}
\subsubsection[{$\sim$\-Thread\-Localize}]{\setlength{\rightskip}{0pt plus 5cm}ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize\-::$\sim$\-Thread\-Localize (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{classohm__tsd__slam__ref_1_1ThreadLocalize_ad6d771a1b24111bff419ecfed45ee470}
Destructor 
...
\hline
{\em Mvalid} & Pointer to valid model points \\
\hline
{\em N} & Pointer to normals of the model \\
\hline
{\em Nvalid} & Pointer to valid normals of the model \\
\hline
{\em S} & Pointer to scene points \\
\hline
{\em Svalid} & Pointer to valid scene points \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
2\-D transformation matrix of type obvious\-::\-Matrix 
\end{DoxyReturn}
\hypertarget{classohm__tsd__slam__ref_1_1ThreadLocalize_ac2ee24d1021f03eaa4abf6420bea46b4}{\index{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize@{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize}!event\-Loop@{event\-Loop}}
\index{event\-Loop@{event\-Loop}!ohm_tsd_slam_ref::ThreadLocalize@{ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize}}
\subsubsection[{event\-Loop}]{\setlength{\rightskip}{0pt plus 5cm}void ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize\-::event\-Loop (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [protected]}, {\ttfamily [virtual]}}}\label{classohm__tsd__slam__ref_1_1ThreadLocalize_ac2ee24d1021f03eaa4abf6420bea46b4}
Abstract function derived from base class \hyperlink{classohm__tsd__slam__ref_1_1ThreadSLAM}{Thread\-S\-L\-A\-M}. Consists of a loop the thread never leaves until a termination call occurs. Create Point Matrices with structure \mbox{[}x1 y1; x2 y2; ..\mbox{]} M, N and S are matrices that preserve the ray model of a laser scanner Xvalid matrices are matrices that do not preserve the ray model but contain only valid points (mask applied) T transformation
...
\subsubsection[{\-\_\-odom\-Analyzer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Odometry\-Analyzer}$\ast$ ohm\-\_\-tsd\-\_\-slam\-\_\-ref\-::\-Thread\-Localize\-::\-\_\-odom\-Analyzer\hspace{0.3cm}{\ttfamily [private]}}}\label{classohm__tsd__slam__ref_1_1ThreadLocalize_a719b8e1a97ec5ba8e859f24b416699a0}
